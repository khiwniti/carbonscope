...
|--------|-------------|----------|-------------|
| `main` | DEV | dev-api.cbim.com | ✅ On push |
| `staging` | STAGING | staging-api.cbim.com | ✅ On push |
| `PRODUCTION` | PRODUCTION | api.cbim.com | ✅ On push |
...
Pulumi Cloud: https://app.pulumi.com/cbim
