...
const ELECTRON_PROTOCOL = 'bim-carbon';
...
export function isElectron(): boolean {
  ...
  // Check user agent for Electron (we append "Electron/BIM Carbon-Desktop" in main.js)
 ...
 * - Web: returns the web URL (https://bim-carbon.com/auth/callback)
 * - Electron: returns the custom protocol URL (bim-carbon://auth/callback)
 */
