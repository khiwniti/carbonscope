...
export const pricingTiers: PricingTier[] = [
  {
    ...
    description: 'Perfect for trying out BIM Carbon Workers',
    ...
    features: [
      ...
      '1 concurrent run',
      'Basic Mode - Core BIM Carbon experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create BIM Carbon Workers with custom Knowledge, Tools & Integrations',
      ...
      'BIM Carbon Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create BIM Carbon Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create BIM Carbon Workers with custom Knowledge, Tools & Integrations',
