...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | BIM Carbon',
    description: 'Replay this Worker conversation on BIM Carbon',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | BIM Carbon';
    const description =
      projectData.description ||
      'Replay this Worker conversation on BIM Carbon';
