                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <div className="text-muted-foreground mb-6">
                        <p>
                          Email:{' '}
                          <a
                            href="mailto:info@bim-carbon.com"
                      ...
                      <p className="text-muted-foreground mb-6">
                        BIM Carbon Corp is responsible for the content of this
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        CAREFULLY BEFORE USING THE SERVICES OFFERED BY BIM Carbon
                        ...
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE BIM Carbon
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        <li>
                          "Company" refers to BIM Carbon Corp, a Delaware corporation
                          with its principal place of business at 701 Tillery Street
                          Unit 12-2521, Austin, Texas 78702, United States.
                        </li>
                        <li>
                          "Site" refers to the BIM Carbon website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
                          "Service" refers to the BIM Carbon platform and all related
                        ...
                        <li>
                          ...
                          Company, specifically legal@bim-carbon.com
                        </li>
                        <li>
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        BIM Carbon is a complete platform for creating, managing, and
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        <a
                          href="https://github.com/bim-carbon-ai/suna/blob/main/LICENSE"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-primary hover:underline"
                        >
                          github.com/bim-carbon-ai/suna/blob/main/LICENSE
                        </a>
                      </p>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        please write to legal@bim-carbon.com and we will process and
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        or by emailing us at info@bim-carbon.com. If you cancel
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        GitHub repository. Self-hosting is governed by the BIM Carbon Public
                        ...
                        and contact{' '}
                        <a
                          href="mailto:hey@bim-carbon.com"
                          className="text-primary hover:underline"
                        >
                          hey@bim-carbon.com
                        </a>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All BIM Carbon logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE BIM Carbon WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        BIM Carbon DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        <a
                          href="mailto:legal@bim-carbon.com"
                          className="text-primary hover:underline"
                        >
                          legal@bim-carbon.com
                        </a>
                        .
                      </p>
                      <p className="text-muted-foreground text-balance mb-4">
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        <strong>Mailing Address:</strong> BIM Carbon Corp, 701 Tillery
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at BIM Carbon in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        BIM Carbon does not collect biometric or identifying
