...
export default function AgentsPage() {
  ...
  const [marketplaceFilter, setMarketplaceFilter] = useState<'all' | 'bim-carbon' | 'community' | 'mine'>('all');
  ...
  const marketplaceQueryParams = useMemo(() => {
    ...
    if (marketplaceFilter === 'bim-carbon') {
      params.is_bim-carbon_team = true;
    } else if (marketplaceFilter === 'community') {
      params.is_bim-carbon_team = false;
    ...
    if (marketplaceTemplates?.templates) {
      marketplaceTemplates.templates.forEach(template => {
        const item: MarketplaceTemplate = {
          ...
          is_bim-carbon_team: template.is_bim-carbon_team,
