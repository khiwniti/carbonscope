...
import '@/styles/carbonscope/globals.css';
...
export const metadata: Metadata = {
  ...
  title: {
    default: 'BKS cBIM AI',
    template: '%s | BKS cBIM AI',
  },
  description: 'Carbon Assessment Platform for Sustainable Construction',
  keywords: ['carbon assessment', 'BIM', 'sustainable construction', 'embodied carbon', 'LCA', 'building lifecycle'],
  authors: [{ name: 'BKS Thailand', url: 'https://bks.co.th' }],
  creator: 'BKS Thailand',
  publisher: 'BKS Thailand',
  applicationName: 'BKS cBIM AI',
  robots: {
    index: true,
    follow: true,
    googleBot: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'BKS cBIM AI – Carbon Assessment Platform for Sustainable Construction',
      },
    ],
  },
  twitter: {
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${roobert.variable} ${roobertMono.variable}`}>
      <head>
        ...
        <title>BKS cBIM AI - Carbon Assessment Platform</title>
        <meta name="description" content="Carbon Assessment Platform for Sustainable Construction. Analyze embodied carbon, optimize building lifecycle, and achieve net-zero goals with AI-powered BIM analysis." />
        <meta name="keywords" content="carbon assessment, BIM, sustainable construction, embodied carbon, LCA, building lifecycle, net zero, green building" />
        <meta property="og:title" content="BKS cBIM AI - Carbon Assessment Platform" />
        <meta property="og:description" content="Carbon Assessment Platform for Sustainable Construction. Analyze embodied carbon, optimize building lifecycle, and achieve net-zero goals." />
        <meta property="og:image" content="https://bks.co.th/banner.png" />
        <meta property="og:url" content="https://bks.co.th" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="BKS cBIM AI" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="BKS cBIM AI - Carbon Assessment Platform" />
        <meta name="twitter:description" content="Carbon Assessment Platform for Sustainable Construction. Analyze embodied carbon, optimize building lifecycle, and achieve net-zero goals." />
        <meta name="twitter:image" content="https://bks.co.th/banner.png" />
        <meta name="twitter:site" content="@bksthailand" />
        <link rel="canonical" href="https://bks.co.th" />
        
        {/* iOS Smart App Banner - shows native install banner in Safari */}
        {!featureFlags.disableMobileAdvertising ? (
          <meta name="apple-itunes-app" content="app-id=6754448524, app-argument=bim-carbon://" />
        ) : null}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ['BIM Carbon', 'BIM Carbon', 'BIM Carbon: Your Autonomous AI Worker'],
              url: siteMetadata.url,
              ...
              sameAs: [
                ...
                'https://x.com/bim-carbon',
                'https://linkedin.com/company/bim-carbon',
              ],
              contactPoint: {
                '@type': 'ContactPoint',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'BIM Carbon'],
