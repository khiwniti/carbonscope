...
import { BIMCarbonLogo as BKSLogo } from '@/components/sidebar/bim-carbon-logo';
    ...
    <div className="min-h-[100dvh] bg-background relative">
      <div className="absolute top-4 sm:top-6 left-4 sm:left-6 z-10">
        <Link href="/" className="flex items-center space-x-2">
          <BKSLogo size={24} className="sm:w-7 sm:h-7" />
        </Link>
      </div>
                ...
                >
                  {t.rich('acceptPrivacyTerms', {
                    privacyPolicy: (chunks) => {
                      return (
                        <a
                          href="https://www.bim-carbon.com/legal?tab=privacy"
                          target="_blank"
                          rel="noopener noreferrer"
                    ...
                    termsOfService: (chunks) => {
                      return (
                        <a
                          href="https://www.bim-carbon.com/legal?tab=terms"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="hover:underline underline-offset-2 text-primary"
                          onClick={(e) => e.stopPropagation()}
