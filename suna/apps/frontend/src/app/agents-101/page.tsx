...
interface Slide {
  ...
  bulletPoints?: string[];
  accent?: string;
  diagram?: 'agent-loop' | 'bim-carbon-stack' | 'task-types' | 'token-flow' | 'messages-array' | 'sandbox-arch' | 'tools-overview';
...
const slides: Slide[] = [
  ...
  },
  {
    ...
    subtitle: 'CEO & COO at BIM Carbon',
  },
  {
    id: 3,
    type: 'title',
    title: 'Demo',
    subtitle: 'Let\'s see BIM Carbon in action',
  },
...
// BIM Carbon Stack Diagram
const BIMCarbonStackDiagram = () => {
  const layers = [
      ...
      {slide.type === 'diagram' && (
        <div className="w-full max-w-4xl">
          ...
          >
            ...
            {slide.diagram === 'bim-carbon-stack' && <BIM CarbonStackDiagram />}
