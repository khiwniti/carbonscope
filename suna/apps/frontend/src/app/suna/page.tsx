...
export const metadata: Metadata = {
  ...
  description: 'Suna has rebranded to BIM Carbon. BIM Carbon (formerly Suna) is the same powerful open source AI assistant and generalist AI worker you know and love, now with a new name and bigger vision.',
  keywords: [
    'Suna',
    'BIM Carbon Suna',
    'Suna AI',
  ...
  openGraph: {
    title: 'Suna is now BIM Carbon',
    description: 'BIM Carbon (formerly Suna) - Same powerful open source AI worker, new name.',
    type: 'website',
    url: 'https://www.bim-carbon.com/suna',
    siteName: 'BIM Carbon',
    images: [
      {
        url: '/banner.png',
  ...
  alternates: {
    canonical: 'https://www.bim-carbon.com/suna',
  },
  robots: {
    index: true,
    follow: true,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: sanitizeJSON({
            ...
            '@type': 'Organization',
            name: 'BIM Carbon',
            alternateName: ['Suna', 'BIM Carbon Suna', 'Suna AI'],
            url: 'https://www.bim-carbon.com',
            logo: 'https://www.bim-carbon.com/favicon.png',
            sameAs: [
              'https://github.com/bim-carbon-ai',
              'https://x.com/bim-carbon',
              'https://linkedin.com/company/bim-carbon',
            ],
            description:
              'BIM Carbon (formerly known as Suna) is an open source generalist AI worker that helps you accomplish real-world tasks through natural conversation.',
          }),
        }}
      />
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: 'Home',
                item: 'https://www.bim-carbon.com',
              },
              {
                '@type': 'ListItem',
                position: 2,
                name: 'Suna is now BIM Carbon',
                item: 'https://www.bim-carbon.com/suna',
              },
            ],
          }),
        }}
        ...
        <div className="relative flex flex-col items-center w-full px-4 sm:px-6">
          ...
          <div className="relative z-10 pt-16 sm:pt-24 md:pt-32 mx-auto h-full w-full max-w-6xl flex flex-col items-center justify-center">
              ...
              <div className="relative mb-8 sm:mb-12" style={{ width: '80px', height: '80px' }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    opacity: 0.6,
                    maskImage: 'url(/bim-carbon-symbol.svg)',
                    WebkitMaskImage: 'url(/bim-carbon-symbol.svg)',
                    maskSize: 'contain',
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full max-w-3xl mx-auto px-2 sm:px-0 pb-16">
              ...
              <a
                href="https://github.com/bim-carbon-ai/suna"
                target="_blank"
            ...
            <div className="space-y-20 sm:space-y-32 text-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 text-base md:text-lg text-muted-foreground font-medium">
                  <p>Our name changed from Suna to BIM Carbon</p>
                  <p>Our domain is now bim-carbon.com</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-base md:text-lg text-muted-foreground font-medium">
                  Our GitHub repository remains at github.com/bim-carbon-ai/suna
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto pb-20 pt-12 border-t border-border/50">
            <p className="text-sm text-muted-foreground/60 leading-relaxed font-medium">
              Looking for Suna? You've found us. BIM Carbon is the evolution of Suna — the same open
              ...
              Suna", or "BIM Carbon Suna" — this is the official continuation of the Suna project under
              the BIM Carbon brand.
            </p>
          </div>
        </div>
      </main>
