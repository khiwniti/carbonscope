...
import { getUserFriendlyToolName, getCompletedToolName, isHiddenTool } from '@bks/cbim-shared/tools';
import { normalizeArrayValue, normalizeAttachments } from '@bks/cbim-shared/utils';
      ...
      {isLatestMessage && (
        <div className="flex items-center gap-2 mt-3">
          ...
          <p className="text-sm text-muted-foreground">
            {t ? t('thread.waitingForUserResponse') : 'BIM Carbon will proceed to work autonomously after you answer.'}
          </p>
        </div>
      )}
