        ...
        <div className="flex gap-3">
          ...
          >
            {downloadingFormat === 'pdf' ? (
              <CarbonScopeLoader customSize={16} variant="white" className="mr-2 dark:hidden" />
            ) : (
              <FileText className="h-4 w-4 mr-2" />
            )}
            {downloadingFormat === 'pdf' ? (
              <CarbonScopeLoader customSize={16} variant="emerald" className="mr-2 hidden dark:flex" />
            ) : null}
            Download PDF
          </Button>
