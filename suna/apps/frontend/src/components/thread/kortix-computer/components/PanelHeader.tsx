...
import { ViewType } from '@/stores/bim-carbon-computer-store';
    ...
    return (
      <div className="h-12 flex-shrink-0 px-3 flex items-center justify-between border-b border-border bg-background/95 backdrop-blur-sm">
        ...
        <div className="flex items-center min-w-0">
          <Image
            src="/bim-carbon-computer-white.svg"
            alt="BIM Carbon Computer"
            width={120}
            height={14}
          ...
          />
          <Image
            src="/bim-carbon-computer-black.svg"
            alt="BIM Carbon Computer"
            width={120}
            height={14}
            ...
            priority
          />
          <DrawerTitle className="sr-only">BIM Carbon Computer</DrawerTitle>
        </div>
