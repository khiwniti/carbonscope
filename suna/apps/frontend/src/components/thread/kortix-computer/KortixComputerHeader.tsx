...
interface BIMCarbonComputerHeaderProps {
...
/**
 * Shared header component for all BIM Carbon Computer views (Files, File Viewer, Browser).
 ...
 */
export function BIMCarbonComputerHeader({
  icon: Icon,
  onIconClick,
  iconTitle,
  title,
