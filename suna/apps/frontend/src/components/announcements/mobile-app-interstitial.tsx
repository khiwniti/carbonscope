...
const STORAGE_KEY = 'bim-carbon-mobile-banner-dismissed';
...
function BIMCarbonLogo({ className }: { className?: string }) {
  return (
          ...
          >
            <div className="p-5 flex items-center gap-4">
              ...
              <div className="w-14 h-14 bg-black dark:bg-white rounded-xl flex items-center justify-center flex-shrink-0">
                <BIMCarbonLogo className="w-7 h-7 text-white dark:text-black" />
              </div>

              {/* Text */}
              <div className="flex-1 min-w-0">
                <h3 className="text-base font-semibold text-neutral-900 dark:text-white mb-0.5">
                  Get BIM Carbon for Mobile
                </h3>
