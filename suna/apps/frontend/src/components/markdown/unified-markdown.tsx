...
import { autoLinkUrls } from '@bks/cbim-shared';
 ...
 * Optimized for BIM Carbon brand with Vercel-level UX/UI polish.
 * 
 * Design principles:
...
export const UnifiedMarkdown = React.memo<UnifiedMarkdownProps>(({
  ...
  return (
    <div 
      className={cn('bim-carbon-markdown', isStreaming && 'streaming-active', className)}
