...
export const EventBasedTriggerDialog: React.FC<EventBasedTriggerDialogProps> = ({ 
    ...
    const [model, setModel] = useState('bim-carbon/basic');
    ...
    useEffect(() => {
        if (isEditMode && existingTrigger && open) {
            ...
            setModel(triggerConfig.model || 'bim-carbon/basic');
                                    ...
                                    {isEditMode && !selectedTrigger && (loadingTriggers || !selectedApp) ? (
                                        <div className="flex-1 flex items-center justify-center p-6">
                                            <div className="text-center space-y-3">
                                                <CarbonScopeLoader size="large" className="mx-auto" />
                                                                    ...
                                                                    <SelectContent>
                                                                        {loadingProfiles ? (
                                                                            <SelectItem value="__loading__" disabled>
                                                                                <div className="flex items-center gap-2">
                                                                                    <CarbonScopeLoader customSize={12} />
                                                                                    <span>Loading...</span>
                                                                                </div>
                                                                            </SelectItem>
                                                                        ) : (
                                                    ...
                                                    <div className="flex justify-end">
                                                        ...
                                                        >
                                                            {(isEditMode ? updateTrigger.isPending : createTrigger.isPending) ? (
                                                                <>
                                                                    <CarbonScopeLoader customSize={12} className="mr-2" />
