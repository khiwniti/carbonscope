...
const BIMCarbonAppBanners = lazy(() => 
  import('@/components/announcements/bim-carbon-app-banners').then(mod => ({ default: mod.BIMCarbonAppBanners }))
);
  ...
  return (
    ...
    >
      <div className="relative h-full">
        ...
        {/* BIM Carbon App announcement banners */}
        <Suspense fallback={null}>
          <BIMCarbonAppBanners disableMobileAdvertising={featureFlags.disableMobileAdvertising} />
        </Suspense>
