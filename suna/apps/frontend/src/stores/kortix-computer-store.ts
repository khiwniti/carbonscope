...
interface BIMCarbonComputerState {
  ...
  // Clear pending tool nav after BIMCarbonComputer processes it
...
export const useBIMCarbonComputerStore = create<BIMCarbonComputerState>()(
  devtools(
    (set, get) => ({
      ...initialState,
    ...
    {
      name: 'bim-carbon-computer-store',
    }
  )
);
...
// Sandbox context
export const useBIMCarbonComputerSandboxId = () =>
  useBIMCarbonComputerStore((state) => state.currentSandboxId);

export const useSetSandboxContext = () =>
  useBIMCarbonComputerStore((state) => state.setSandboxContext);

// Main view state
export const useBIMCarbonComputerActiveView = () => 
  useBIMCarbonComputerStore((state) => state.activeView);

// Individual selectors for files state (stable, primitive values)
export const useBIMCarbonComputerFilesSubView = () =>
  useBIMCarbonComputerStore((state) => state.filesSubView);

export const useBIMCarbonComputerCurrentPath = () =>
  useBIMCarbonComputerStore((state) => state.currentPath);

export const useBIMCarbonComputerSelectedFilePath = () =>
  useBIMCarbonComputerStore((state) => state.selectedFilePath);

export const useBIMCarbonComputerFilePathList = () =>
  useBIMCarbonComputerStore((state) => state.filePathList);

export const useBIMCarbonComputerCurrentFileIndex = () =>
  useBIMCarbonComputerStore((state) => state.currentFileIndex);

// Legacy combined selector (for backward compatibility) - use individual selectors in components
export const useBIMCarbonComputerFilesState = () => ({
  filesSubView: useBIMCarbonComputerStore((state) => state.filesSubView),
  currentPath: useBIMCarbonComputerStore((state) => state.currentPath),
  selectedFilePath: useBIMCarbonComputerStore((state) => state.selectedFilePath),
  filePathList: useBIMCarbonComputerStore((state) => state.filePathList),
  currentFileIndex: useBIMCarbonComputerStore((state) => state.currentFileIndex),
});

// Actions are stable references (functions don't change)
export const useBIMCarbonComputerActions = () =>
  useBIMCarbonComputerStore((state) => ({
...
export const useBIMCarbonComputerPendingToolNavIndex = () =>
  useBIMCarbonComputerStore((state) => state.pendingToolNavIndex);

export const useBIMCarbonComputerClearPendingToolNav = () =>
  useBIMCarbonComputerStore((state) => state.clearPendingToolNav);

// Side panel state selectors
export const useIsSidePanelOpen = () =>
  useBIMCarbonComputerStore((state) => state.isSidePanelOpen);

export const useSetIsSidePanelOpen = () =>
  useBIMCarbonComputerStore((state) => state.setIsSidePanelOpen);
