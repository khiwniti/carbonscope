...
Minimal Electron wrapper for the BKS cBIM AI web application with deep linking support.

## Features

- Native macOS/Windows/Linux desktop app
- Deep linking for magic link authentication (`cbim://` protocol)
...
By default, it loads `https://cbim.com/`.
...
The app registers the `cbim://` protocol for magic link authentication:

1. User enters email in desktop app
2. Magic link email contains `cbim://auth/callback?code=xxx`
3. User clicks link in email
4. Operating system opens BKS cBIM Desktop app
