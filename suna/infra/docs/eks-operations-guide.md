# BKS cBIM AI EKS Operations Guide
...
```
User request
  → Cloudflare DNS (api-eks.cbim.com)
...
The EKS cluster is the main production target. Lightsail and ECS are still deployed to, but EKS handles the real traffic through `api-eks.cbim.com`.
...
- **Uptime:** Set up HTTP monitors for `api-eks.cbim.com`
