...
[![Twitter Follow](https://img.shields.io/twitter/follow/cbim)](https://x.com/cbim)
[![GitHub Repo stars](https://img.shields.io/github/stars/cbim-ai/suna)](https://github.com/cbim-ai/suna)
[![Issues](https://img.shields.io/github/issues/cbim-ai/suna)](https://github.com/cbim-ai/suna/labels/bug)

<!-- Keep these links. Translations will automatically update with the README. -->
[Deutsch](https://www.readme-i18n.com/cbim-ai/suna?lang=de) | 
[Español](https://www.readme-i18n.com/cbim-ai/suna?lang=es) | 
[français](https://www.readme-i18n.com/cbim-ai/suna?lang=fr) | 
[日本語](https://www.readme-i18n.com/cbim-ai/suna?lang=ja) | 
[한국어](https://www.readme-i18n.com/cbim-ai/suna?lang=ko) | 
[Português](https://www.readme-i18n.com/cbim-ai/suna?lang=pt) | 
[Русский](https://www.readme-i18n.com/cbim-ai/suna?lang=ru) | 
[中文](https://www.readme-i18n.com/cbim-ai/suna?lang=zh)

![BKS cBIM AI Screenshot](apps/frontend/public/banner.png)
</div>




## 🌟 What Makes BKS cBIM AI Special

### 🤖 Includes BKS cBIM AI Super Worker – Flagship Generalist AI Worker
Meet BKS cBIM AI Super Worker, our showcase agent that demonstrates the full power of the BKS cBIM AI platform. Through natural conversation, BKS cBIM AI Super Worker handles research, data analysis, browser automation, file management, and complex workflows – showing you what's possible when you build with BKS cBIM AI.

### 🔧 Build Custom BKS cBIM AI Super Worker-Type Agents
Create your own specialized agents tailored to specific domains, workflows, or business needs. Whether you need agents for customer service, data processing, content creation, or industry-specific tasks, BKS cBIM AI provides the infrastructure and tools to build, deploy, and scale them.
...
- [🌟 What Makes BKS cBIM AI Special](#-what-makes-cbim-special)
...
### BKS cBIM AI Super Worker - Your Generalist AI Worker

BKS cBIM AI Super Worker demonstrates the full capabilities of the BKS cBIM AI platform as a versatile AI worker that can:
...
The BKS cBIM AI platform enables you to create agents tailored to specific needs:
...
BKS cBIM AI consists of four main components that work together to provide a complete AI agent development platform:
...
Get your BKS cBIM AI platform running in minutes with our automated setup wizard:

### 1️⃣ Clone the Repository
```bash
git clone https://github.com/cbim-ai/suna.git
cd suna
```
...
That's it! Your BKS cBIM AI platform will be running with BKS cBIM AI Super Worker ready to assist you. Ty mate
---
...
[Get Started](./docs/SELF-HOSTING.md) • [Join Discord](https://discord.com/invite/RvFhXUdZ9H) • [Follow on Twitter](https://x.com/cbim)
