...
SUNA_CONFIG = {
    "name": "BKS cBIM AI",
    "description": "BKS cBIM AI is your carbon assessment assistant with specialized tools for EN 15978 compliant lifecycle analysis and sustainable building design.",
    "model": "bks-cbim/basic",
