          ...
          <div className="p-4 sm:p-8 overflow-y-auto">
            ...
            <div className="flex flex-col items-center text-center mb-4 sm:mb-6">
              <div className="mb-2 sm:mb-4 p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-muted/50">
                <CarbonScopeLogoSimple size={24} className="sm:hidden" />
                <CarbonScopeLogoSimple size={32} className="hidden sm:block" />
              </div>
            ...
            <div className="flex flex-col gap-2 sm:gap-3">
              ...
              <Button onClick={resetAndClose} className="w-full h-9 sm:h-10 text-sm text-muted-foreground">
                {t('keepCurrentPlan')}
              </Button>
            </div>
          </div>
