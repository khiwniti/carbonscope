          ...
          <div className="col-span-2 md:col-span-1 space-y-4">
            <Link href="/" className="inline-flex items-center gap-2 group">
              ...
              <span className="md:hidden">
                <CarbonScopeLogoSimple size={18} />
              </span>
              <span className="hidden md:block">
                <CarbonScopeLogoSimple size={24} />
              </span>
            </Link>
            {/* Social links */}
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                aria-label="GitHub"
                className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-muted/50 hover:bg-muted transition-all duration-300 group hover:scale-105"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  className="size-4 text-muted-foreground group-hover:text-foreground transition-all duration-300 group-hover:rotate-12"
                >
                  <path
                    fill="currentColor"
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Discord"
                className="p-2 rounded-lg bg-muted/50 hover:bg-muted transition-all duration-300 group hover:scale-110 hover:-translate-y-0.5"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  className="size-4 text-muted-foreground group-hover:text-foreground transition-all duration-300 group-hover:scale-110"
                >
                  <path
                    fill="currentColor"
        ...
        <div className="mt-12 pt-8 border-t border-border/40">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              © {currentYear} BKS - CarbonScope. All rights reserved.
            </p>
