...
const ELECTRON_PROTOCOL = 'CarbonScope';
...
export function isElectron(): boolean {
  ...
  // Check user agent for Electron (we append "Electron/CarbonScope-Desktop" in main.js)
 ...
 * - Web: returns the web URL (https://CarbonScope.com/auth/callback)
 * - Electron: returns the custom protocol URL (CarbonScope://auth/callback)
 */
