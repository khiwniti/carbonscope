...
class Configuration:
    ...
    MEMORY_EXTRACTION_MODEL: Optional[str] = "CarbonScope/basic"
    ...
    OR_SITE_URL: Optional[str] = "https://www.CarbonScope.com"
    OR_APP_NAME: Optional[str] = "CarbonScope.com"
    ...
    CarbonScope_ADMIN_API_KEY: Optional[str] = None
    ...
    def FRONTEND_URL(self) -> str:
        ...
        Returns:
        - Production: 'https://CarbonScope.com' (or FRONTEND_URL_ENV if set)
        - Staging: 'https://staging.CarbonScope.com' (or FRONTEND_URL_ENV if set)
    ...
    def _generate_admin_api_key(self) -> str:
        """Generate a secure admin API key for CarbonScope administrative functions."""
    ...
    def __init__(self):
        ...
        if not self.CarbonScope_ADMIN_API_KEY:
            self.CarbonScope_ADMIN_API_KEY = self._generate_admin_api_key()
            logger.info("Auto-generated CarbonScope_ADMIN_API_KEY for administrative functions")
