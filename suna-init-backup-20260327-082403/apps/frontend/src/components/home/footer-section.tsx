...
import { SunaLogo } from '@/components/sidebar/suna-logo';
    ...
    <footer id="footer" style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <Link href="/" style={{
                ...
                <span style={{ display: tablet ? 'block' : 'none' }}>
                  <SunaLogo size={18} variant="logomark" />
                </span>
                <span style={{ display: tablet ? 'none' : 'block' }}>
                  <SunaLogo size={20} variant="symbol" />
                </span>
              </Link>
              <p style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                alignItems: tablet ? 'flex-start' : 'center',
                justifyContent: 'space-between',
                gap: tablet ? '1.25rem' : 0,
                paddingLeft: tablet ? 0 : '2.5rem',
              }}>
                {siteConfig.footerLinks.map((column, columnIndex) => (
                  <ul key={columnIndex} style={{
                    display: 'flex',
                    flexDirection: 'column',
                    gap: '0.5rem',
                  }}>
                    ...
                    {column.links.map((link) => (
                      ...
                      >
                        ...
                        >
                          <ChevronRightIcon style={{ height: '1rem', width: '1rem', color: '#64748B' }} />
                        </div>
                      </li>
                    ))}
                  </ul>
      ...
      >
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(to top, transparent 0%, #0B1120 40%)',
          zIndex: 10,
        }} />
